...
if st.session_state.seite == "page1":
    ...
    img11 = image_select(
        "Label",
        [
            "https://www.dropbox.com/scl/fi/hnqpi3dys2n14foc75fuk/bad-sets-komponenten-keine-auswahl.jpg?rlkey=e7bcpijflx8q3co9gb4v1kivn&dl=1",
...
if st.session_state.seite == "page2":
    ...
    st.button("Weiter zu Frage 3", on_click=lambda: wechsel_zu("page3"))
...
if st.session_state.seite == "page3":
    ...
    st.button("Weiter zu Frage 4", on_click=lambda: wechsel_zu("page4"))
...
if st.session_state.seite == "page4":
    ...
    st.button("Weiter zu Frage 5", on_click=lambda: wechsel_zu("page5"))
...
if st.session_state.seite == "page5":
    ...
    st.button("Weiter zu Frage 6", on_click=lambda: wechsel_zu("page6"))
...
if st.session_state.seite == "page6":
    ...
    st.button("Weiter zu Frage 7", on_click=lambda: wechsel_zu("page7"))
...
if st.session_state.seite == "page7":
    ...
    st.button("Weiter zu Frage 8", on_click=lambda: wechsel_zu("page8"))
...
if st.session_state.seite == "page8":
    ...
    st.button("Weiter zu Frage 9", on_click=lambda: wechsel_zu("page9"))
...
if st.session_state.seite == "page9":
    ...
    st.button("Weiter zu Frage 10", on_click=lambda: wechsel_zu("page10"))
...
if st.session_state.seite == "page10":
    ...
    st.button("Weiter zu Frage 11", on_click=lambda: wechsel_zu("auswertung"))
