...
use_model = True         # Klassifikation mit Modell
use_relative = False       # True = Verhältnis edges/pixels; False = absolute edges
...
for label, stats in label_stats.items():
    ...
    if anz_l > 0 and label not in ["portrait", "waste"]:  # Optionaler Ausschluss
        for key in f1_v:
